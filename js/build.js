...
wanakana = wanakana || {}, wanakana.version = "1.3.7", "function" == typeof define && define.amd && define("wanakana", [], function() {
    ...
    for (b = wanakana._extend(b, wanakana.defaultOptions), g = a.length, k = [], e = 0, d = 0, h = 2, f = function() {
        ...
        for (j(); d > 0; ) {
            if (c = f(), wanakana.isKatakana(c) && (c = wanakana._katakanaToHiragana(c)), "Á" === c.charAt(0) && 1 === d && g - 1 > e) {
                i = !0, l = "";
                break
            }
    ...
    for (null == c && (c = !1), b = wanakana._extend(b, wanakana.defaultOptions), l = a.length, j = [], g = 0, m = 3, h = function() {
        ...
        for (f = Math.min(m, l - g); f > 0; ) {
            if (d = h(), e = d.toLowerCase(), __indexOf.call(wanakana.FOUR_CHARACTER_EDGE_CASES, e) >= 0 && l - g >= 4)
                ...
                "n" !== e.charAt(0) && wanakana._isCharConsonant(e.charAt(0)) && d.charAt(0) === d.charAt(1) && (f = 1, e = d = wanakana._isCharInRange(d.charAt(0), wanakana.UPPERCASE_START, wanakana.UPPERCASE_END) ? "Ģ" : "Á")
            }
            if (k = wanakana.R_to_J[e], null != k)
                break;
            4 === f ? f -= 2 : f--
        }
        null == k && (d = wanakana._convertPunctuation(d), k = d), (null != b ? b.useObseleteKana : void 0) && ("wi" === e && (k = "î"), "we" === e && (k = "ï")), b.IMEMode && "n" === e.charAt(0) && ("y" === a.charAt(g + 1).toLowerCase() && wanakana._isCharVowel(a.charAt(g + 2)) === !1 || g === l - 1 || wanakana.isKana(a.charAt(g + 1))) && (k = d.charAt(0)), c || i(d.charAt(0)) && (k = wanakana._hiraganaToKatakana(k)), j.push(k), g += f || 1
    }
    return j.join("")
...
}, wanakana.R_to_J = {a: " ",i: "¢",u: "¤",e: "¦",o: "¨",yi: "¢",wu: "¤",whu: "¤",xa: "",xi: "¡",xu: "£",xe: "¥",xo: "§",xyi: "¡",xye: "¥",ye: "¢¥",wha: "¤",whi: "¤¡",whe: "¤¥",who: "¤§",wi: "¤¡",we: "¤¥",va: "Ô",vi: "Ô¡",vu: "Ô",ve: "Ô¥",vo: "Ô§",vya: "Ôá",vyi: "Ô¡",vyu: "Ôã",vye: "Ô¥",vyo: "Ôå",ka: "©",ki: "«",ku: "­",ke: "¯",ko: "±",lka: "Õ",lke: "Ö",xka: "Õ",xke: "Ö",kya: "«á",kyi: "«¡",kyu: "«ã",kye: "«¥",kyo: "«å",ca: "©",ci: "«",cu: "­",ce: "¯",co: "±",lca: "Õ",lce: "Ö",xca: "Õ",xce: "Ö",qya: "­á",qyu: "­ã",qyo: "­å",qwa: "­",qwi: "­¡",qwu: "­£",qwe: "­¥",qwo: "­§",qa: "­",qi: "­¡",qe: "­¥",qo: "­§",kwa: "­",qyi: "­¡",qye: "­¥",ga: "ª",gi: "¬",gu: "®",ge: "°",go: "²",gya: "¬á",gyi: "¬¡",gyu: "¬ã",gye: "¬¥",gyo: "¬å",gwa: "®",gwi: "®¡",gwu: "®£",gwe: "®¥",gwo: "®§",sa: "³",si: "µ",shi: "µ",su: "·",se: "¹",so: "»",za: "´",zi: "¶",zu: "¸",ze: "º",zo: "¼",ji: "¶",sya: "µá",syi: "µ¡",syu: "µã",sye: "µ¥",syo: "µå",sha: "µá",shu: "µã",she: "µ¥",sho: "µå",shya: "µá",shyu: "µã",shye: "µ¥",shyo: "µå",swa: "·",swi: "·¡",swu: "·£",swe: "·¥",swo: "·§",zya: "¶á",zyi: "¶¡",zyu: "¶ã",zye: "¶¥",zyo: "¶å",ja: "¶á",ju: "¶ã",je: "¶¥",jo: "¶å",jya: "¶á",jyi: "¶¡",jyu: "¶ã",jye: "¶¥",jyo: "¶å",ta: "½",ti: "¿",tu: "Â",te: "Ä",to: "Æ",chi: "¿",tsu: "Â",ltu: "Á",xtu: "Á",tya: "¿á",tyi: "¿¡",tyu: "¿ã",tye: "¿¥",tyo: "¿å",cha: "¿á",chu: "¿ã",che: "¿¥",cho: "¿å",cya: "¿á",cyi: "¿¡",cyu: "¿ã",cye: "¿¥",cyo: "¿å",chya: "¿á",chyu: "¿ã",chye: "¿¥",chyo: "¿å",tsa: "Â",tsi: "Â¡",tse: "Â¥",tso: "Â§",tha: "Äá",thi: "Ä¡",thu: "Äã",the: "Ä¥",tho: "Äå",twa: "Æ",twi: "Æ¡",twu: "Æ£",twe: "Æ¥",two: "Æ§",da: "¾",di: "À",du: "Ã",de: "Å","do": "Ç",dya: "Àá",dyi: "À¡",dyu: "Àã",dye: "À¥",dyo: "Àå",dha: "Åá",dhi: "Å¡",dhu: "Åã",dhe: "Å¥",dho: "Åå",dwa: "Ç",dwi: "Ç¡",dwu: "Ç£",dwe: "Ç¥",dwo: "Ç§",na: "È",ni: "É",nu: "Ê",ne: "Ë",no: "Ì",nya: "Éá",nyi: "É¡",nyu: "Éã",nye: "É¥",nyo: "Éå",ha: "Í",hi: "Ð",hu: "Ó",he: "Ö",ho: "Ù",fu: "Ó",hya: "Ðá",hyi: "Ð¡",hyu: "Ðã",hye: "Ð¥",hyo: "Ðå",fya: "Óá",fyu: "Óã",fyo: "Óå",fwa: "Ó",fwi: "Ó¡",fwu: "Ó£",fwe: "Ó¥",fwo: "Ó§",fa: "Ó",fi: "Ó¡",fe: "Ó¥",fo: "Ó§",fyi: "Ó¡",fye: "Ó¥",ba: "Î",bi: "Ñ",bu: "Ô",be: "×",bo: "Ú",bya: "Ñá",byi: "Ñ¡",byu: "Ñã",bye: "Ñ¥",byo: "Ñå",pa: "Ï",pi: "Ò",pu: "Õ",pe: "Ø",po: "Û",pya: "Òá",pyi: "Ò¡",pyu: "Òã",pye: "Ò¥",pyo: "Òå",ma: "Ü",mi: "Ý",mu: "Þ",me: "ß",mo: "à",mya: "Ýá",myi: "Ý¡",myu: "Ýã",mye: "Ý¥",myo: "Ýå",ya: "â",yu: "ä",yo: "æ",xya: "á",xyu: "ã",xyo: "å",ra: "ç",ri: "è",ru: "é",re: "ê",ro: "ë",rya: "èá",ryi: "è¡",ryu: "èã",rye: "è¥",ryo: "èå",la: "ç",li: "è",lu: "é",le: "ê",lo: "ë",lya: "èá",lyi: "è¡",lyu: "èã",lye: "è¥",lyo: "èå",wa: "í",wo: "ð",lwe: "ì",xwa: "ì",n: "ñ",nn: "ñ","n ": "ñ",xn: "ñ",ltsu: "Á"}, wanakana.FOUR_CHARACTER_EDGE_CASES = ["lts", "chy", "shy"], wanakana.J_to_R = {" ": "a","¢": "i","¤": "u","¦": "e","¨": "o","Ô": "va","Ô¡": "vi","Ô": "vu","Ô¥": "ve","Ô§": "vo","©": "ka","«": "ki","«á": "kya","«¡": "kyi","«ã": "kyu","­": "ku","¯": "ke","±": "ko","ª": "ga","¬": "gi","®": "gu","°": "ge","²": "go","¬á": "gya","¬¡": "gyi","¬ã": "gyu","¬¥": "gye","¬å": "gyo","³": "sa","·": "su","¹": "se","»": "so","´": "za","¸": "zu","º": "ze","¼": "zo","µ": "shi","µá": "sha","µã": "shu","µå": "sho","¶": "ji","¶á": "ja","¶ã": "ju","¶å": "jo","½": "ta","¿": "chi","¿á": "cha","¿ã": "chu","¿å": "cho","Â": "tsu","Ä": "te","Æ": "to","¾": "da","À": "di","Ã": "du","Å": "de","Ç": "do","È": "na","É": "ni","Éá": "nya","Éã": "nyu","Éå": "nyo","Ê": "nu","Ë": "ne","Ì": "no","Í": "ha","Ð": "hi","Ó": "fu","Ö": "he","Ù": "ho","Ðá": "hya","Ðã": "hyu","Ðå": "hyo","Ó": "fa","Ó¡": "fi","Ó¥": "fe","Ó§": "fo","Î": "ba","Ñ": "bi","Ô": "bu","×": "be","Ú": "bo","Ñá": "bya","Ñã": "byu","Ñå": "byo","Ï": "pa","Ò": "pi","Õ": "pu","Ø": "pe","Û": "po","Òá": "pya","Òã": "pyu","Òå": "pyo","Ü": "ma","Ý": "mi","Þ": "mu","ß": "me","à": "mo","Ýá": "mya","Ýã": "myu","Ýå": "myo","â": "ya","ä": "yu","æ": "yo","ç": "ra","è": "ri","é": "ru","ê": "re","ë": "ro","èá": "rya","èã": "ryu","èå": "ryo","í": "wa","ð": "wo","ñ": "n","î": "wi","ï": "we","«¥": "kye","«å": "kyo","¶¡": "jyi","¶¥": "jye","¿¡": "cyi","¿¥": "che","Ð¡": "hyi","Ð¥": "hye","Ñ¡": "byi","Ñ¥": "bye","Ò¡": "pyi","Ò¥": "pye","Ý¥": "mye","Ý¡": "myi","è¡": "ryi","è¥": "rye","É¡": "nyi","É¥": "nye","µ¡": "syi","µ¥": "she","¢¥": "ye","¤": "wha","¤§": "who","¤¡": "wi","¤¥": "we","Ôá": "vya","Ôã": "vyu","Ôå": "vyo","·": "swa","·¡": "swi","·£": "swu","·¥": "swe","·§": "swo","­á": "qya","­ã": "qyu","­å": "qyo","­": "qwa","­¡": "qwi","­£": "qwu","­¥": "qwe","­§": "qwo","®": "gwa","®¡": "gwi","®£": "gwu","®¥": "gwe","®§": "gwo","Â": "tsa","Â¡": "tsi","Â¥": "tse","Â§": "tso","Äá": "tha","Ä¡": "thi","Äã": "thu","Ä¥": "the","Äå": "tho","Æ": "twa","Æ¡": "twi","Æ£": "twu","Æ¥": "twe","Æ§": "two","Àá": "dya","À¡": "dyi","Àã": "dyu","À¥": "dye","Àå": "dyo","Åá": "dha","Å¡": "dhi","Åã": "dhu","Å¥": "dhe","Åå": "dho","Ç": "dwa","Ç¡": "dwi","Ç£": "dwu","Ç¥": "dwe","Ç§": "dwo","Ó£": "fwu","Óá": "fya","Óã": "fyu","Óå": "fyo","": "a","¡": "i","¥": "e","£": "u","§": "o","á": "ya","ã": "yu","å": "yo","Á": "","?": "ka","?": "ka","ì": "wa","": " ","ñ ": "n'a","ñ¢": "n'i","ñ¤": "n'u","ñ¦": "n'e","ñ¨": "n'o","ñâ": "n'ya","ñä": "n'yu","ñæ": "n'yo"};
...
Utility.prototype = {
    ...
    makeJaVi: function(data, cur_new_word) {
        ...
        for (var i = 0; data != null && i < data.length; i++) {
            ...
            txt += '<p class="word">¹' + data[i].word + 'º</p>';
            txt += '<p class="reb">' + data[i].phonetic + '</p>';
            for (var j = 0; data[i].means != null && j < data[i].means.length; j++) {
                txt += '<p class="field">Y' + data[i].means[j].kind + '</p>';
                txt += '<p class="ja-mean">_' + data[i].means[j].mean + '</p>';
                for (var k = 0; k < data[i].means[j].examples.length; k++) {
                    txt += '<p class="ja-example">f' + data[i].means[j].examples[k].content + '</p>';
        ...
        for (var r = 0; r < list.length; r++) {
            for (var i = 0; data != null && i < data.length; i++) {
                ...
                if (list[r] == item.kanji) {
                    txt += '<div class ="result-box">';
                    txt += '<p class="word">¹' + item.kanji + 'º</p>';
                    ...
                    if (item.detail != null)
                        txt += '<p class="detail">f ' + item.detail.replace(/##/g, "<br/>f ") + '</p></div>';
...
ShowPanel.prototype = {
    applySetting: function() {
        ...
        if (!isNaN(timeDelay) && timeDelay > 0) {
            if (timeDelay == null || timeDelay < timeShow+TIME_LOAD_SOUND)
                timeDelay = timeShow+TIME_LOAD_SOUND;
